...
<mujoco model="default_scene">
  ...
  <asset>
    ...
    <texture name="chess_tex" type="2d" file="asset/obj/chessboard.png"/>
    <material name="chess_mat" texture="chess_tex" texrepeat="1 1"/>
  </asset>
  ...
  <worldbody>
    ...
    <body name="cam_mount" mocap="true" pos="0 0 0" quat="1 0 0 0">
      <camera name="cam0" pos="0 0 0" quat="1 0 0 0"/>
    </body>
